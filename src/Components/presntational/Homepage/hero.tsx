...
function Hero() {
  return (
    <Flex mt="3rem">
          <Box w="60%" mr="50px">
              <Heading p="0px" m="0px" mb="1rem" fontSize={{ sm: "2.5rem", md: "3.5rem", lg: "4rem", xl:"5rem" }}>
                  Drive <Box p="0px" m="0px" display="inline" position="relative">Revenue</Box> Digital Marketing Agency That
              </Heading>
              <Text w={{ sm:"95%", lg:"80%"}} mb="1rem" >Choose upnex as your digital marketing and propel your business ro new heights with our award winning digital marketing services and technology platforms</Text>
          ...
          <Img src="/images/2.jpg" w="40%" h={{lg:"600px", xl:"600px" }} /> 
    </Flex>
  )
}
